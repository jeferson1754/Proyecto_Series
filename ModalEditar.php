      ...
      <form method="POST" action="recib_Update.php">
        ...
        <div class="modal-body" id="cont_modal">
          ...
          <div class="form-group">
            ...
            <select name="fila11" class="form-control">
                <option value="<?php echo $mostrar[$fila11]; ?>"><?php echo $mostrar[$fila11]; ?></option>
              <?php
              $query = $conexion->query("SELECT $fila8 FROM `$tabla2`;");
          ...
          <div class="form-group">
            ...
            <input type="number" name="fila3" min="1" class="form-control" value="<?php echo $mostrar[$fila3]; ?>">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label"><?php echo $fila4 ?></label>
            <input type="number" name="fila4" MIN="1" class="form-control" value="<?php echo $mostrar[$fila4]; ?>">
          </div>
          <div class="form-group">
