...
try {
    ...
    $stmt = $conn->prepare("SELECT ID FROM calificaciones_series WHERE ID_Serie = :id_anime AND Temporadas = :nombre_anime");
    ...
    if ($row) {
        ...
        $sql = "UPDATE calificaciones_series 
        ...
        $sql = "INSERT INTO calificaciones_series 
        (ID_Serie, Temporadas, Calificacion_1, Calificacion_2, Calificacion_3, Calificacion_4, Calificacion_5) 
