...
<head>
    ...
    <title>Calificaciones de Series</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="anime-grid">
            ...
            $sql = "SELECT series.Nombre as Anime, 
            AVG(calificaciones_series.Promedio) AS PromedioGeneral, 
            calificaciones_series.* FROM calificaciones_series 
            INNER JOIN series ON calificaciones_series.ID_Serie = series.ID 
            WHERE calificaciones_series.Promedio > 0 
            GROUP BY calificaciones_series.ID_Serie 
            ...
            ?>
                    <div class="rating-box">
                        ...
                        $sql_temporada = "SELECT Temporadas, AVG(Promedio) AS promedio_temporada FROM calificaciones_series WHERE ID_Serie = " . $fila['ID_Serie'] . " GROUP BY Temporadas ORDER BY `calificaciones_series`.`ID` ASC";
                        ...
                        ?>
                            ...
                            <button class="btn btn-info mt-2" onclick="toggleSeasons(<?php echo $fila['ID_Serie']; ?>)">
                                Ver Temporadas
                                <i class="fas fa-chevron-down" id="arrow-<?php echo $fila['ID_Serie']; ?>"></i> <!-- Flecha hacia abajo al principio -->
                            </button>

                            <!-- Contenedor de temporadas -->
                            <div id="seasons-<?php echo $fila['ID_Serie']; ?>" class="seasons-container" style="display: none; margin-top: 10px;">
