                ...
                <table id="animeTable" class="table custom-table">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['sin_calificar'])) {
                            $where[] = "calificaciones_series.Promedio = 0.0";
                        }
                        ...
                        $sql = "SELECT series.Nombre as Anime, calificaciones_series.* 
                            FROM calificaciones_series 
                            INNER JOIN series ON series.ID = calificaciones_series.ID_Serie 
                            $where_clause 
                            ORDER BY calificaciones_series.ID DESC";
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <a href="editar_stars.php?id=<?php echo $mostrar['ID_Serie']; ?>&nombre=<?php echo $variable_nombre; ?>&temporada=<?php echo $variable_temporada; ?>"
