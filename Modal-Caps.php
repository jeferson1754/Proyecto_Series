    ...
    <div class="modal-content shadow-lg border-0 rounded-lg">
      <div class="modal-header bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div class="d-flex align-items-center">
          ...
          <h5 class="modal-title fw-bold">Actualizar Capitulos</h5>
        </div>
      ...
      <form method="POST" action="recib_Update-Cap.php" class="needs-validation" id="modal_caps<?php echo $mostrar[$fila7]; ?>" novalidate>
        ...
        <div class="modal-body p-4">
          <div class="text-center">
              ...
              <div class="col-6">
                <div class="card border-0 bg-light hover-shadow transition-all h-100">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted mb-2">Capitulos Vistos</h6>
              ...
              <div class="col-6">
                <div class="card border-0 bg-light hover-shadow transition-all h-100">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted mb-2">Temporada</h6>
            ...
            <div class="mt-4">
              <label class="form-label fw-bold mb-3">Actualizar Capitulos Vistos</label>
              ...
              <div id="vistosError<?php echo $mostrar[$fila7]; ?>" class="invalid-feedback">
                Por favor ingrese un número válido de capitulos
              </div>
            </div>
          </div>
        </div>
